...
def run_simulation():
    print("\n" + "="*70)
    print("🤖 ROBOT DEVELOPMENT: INVERSE KINEMATICS")
    print("="*70)
    print("Learning Body Control through Motor Babbling")
    print("Stages: Tummy Time → Crawling → Standing → Walking")
